...
public class DateAndTime_02_Test {
	...
	public void test_localDate_format() {
        ...
        LocalDate result = LocalDate.of(2015, 3, 11);

        // TODO Formatter la date pour que le test soit passant
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd - MM - yyyy");
        String formattedDate = result.format(formatter);

        assertThat(formattedDate, is("11 - 03 - 2015"));
    }
	  ...
	  @Test(expected = UnsupportedTemporalTypeException.class)
	    public void test_localDate_format_with_hour() {
	        ...
	        // Cela va lever une exception car LocalDate ne supporte pas les heures.
	        String formattedDate = localDate.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"));
	    }
